# ------------------------------------------------------------------------ #
# Title: Assignment 09 - Processing Classes
# Description: Processing Class module for Assignment 09
...
class FileProcessor:
    ...
    def save_data_to_file(file_name: str, list_of_objects: list):
        """ Write data to a file from a list of objects rows

        :param file_name: (string) with name of file
        :param list_of_objects: (list) of objects data saved to file
        :return: (bool) with stats of success status
        """
